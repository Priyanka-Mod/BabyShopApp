            ...
            onBackPress={() => navigation.dispatch(DrawerActions.toggleDrawer())}
              ...
              <View className="rounded-xl border-2 my-[15px] border-lightergray mx-4">
                ...
                <View className="py-2 px-6">
                    <Text className="text-black dark:text-white font-bold text-[15px]">Lorem Ipsum is simply dummy text of printing text of the printing.......</Text>
              ...
              <View className="rounded-xl border-2 my-[15px] border-lightergray mx-4" >
                <View className="flex-row gap-2 items-center mx-5 py-3 border-b-2 border-lightergray">
                    ...
                    <Text className="text-5 font-normal text-[#a2a2a2] text-xl">VDAY40</Text>
                </View>
                <View className="py-2 px-6">
